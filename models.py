...
class Usuario(UserMixin, db.Model):
    ...
    archivos = db.relationship(
        "Archivo", backref="propietario", lazy=True, foreign_keys="Archivo.usuario_id"
    )
    carpetas = db.relationship(
        "Carpeta", backref="propietario", lazy=True, foreign_keys="Carpeta.usuario_id"
    )
...
class Carpeta(db.Model):
    ...
    subcarpetas = db.relationship(
        "Carpeta", backref=db.backref("padre", remote_side=[id]), lazy=True
    )
    # Relación con archivos
    archivos = db.relationship(
        "Archivo", backref="carpeta", lazy=True, cascade="all, delete-orphan"
    )
